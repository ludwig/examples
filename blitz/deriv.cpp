// From http://www.oonumerics.org/blitz/examples/Blitz++/deriv.cpp
...
int main()
{
    ...
    double delta = 1.0 / numSamples;    // Spacing of samples
    Range R(0, numSamples-1);           // Index set of the vector

    // Sample the function y = cos(x)^2 over [0,1)
    //
    // An object of type Range can be treated as a vector, and
    // used as a term in vector expressions.
    //
    // The initialization for y (below) will be translated via
    // expression templates into something of the flavour
    //
    ...
    // }
    //
    // The variable i comes from the blitz::tensor namespace,
    // and is an "index placeholder" which represents an array
    // index.
    ...
    // This range constructor means elements 1 to 91 in
    // increments of 15.
...
/* Output:
    ...
    Exact derivative:7
     [   -1.9996  -1.89847  -1.62776  -1.21164 -0.687291 -0.101549  0.493265
       ]
    Approximation   :7
     [  -1.99953  -1.89841   -1.6277   -1.2116 -0.687269 -0.101546  0.493248
       ]
