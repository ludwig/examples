...
//
//  http://www.oonumerics.org/blitz/examples/Blitz++/erf.cpp
//  http://nwg.phy.bnl.gov/~bviren/elbo/libnuosc++/blitz-0.6/examples/erf.cpp
//
...
int main()
{
    ...
    // For comparison purposes, we use the built-in erf(x) function.
    Vector<double> z = erf(R * dt);
    cout << "Built-in: " << endl;
    cout << z(displayRange+1) << endl;
    cout << endl;
    ...
    // For the following rules, it's easier to work with
    // a sampled integrand.
