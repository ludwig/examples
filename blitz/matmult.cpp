...
int main()
{
    ...
    // we'll make the valid index range 1..4 (rather than 0..3 which
    // is the default).
    ...
    // contraction (or summation) along k. In Blitz++, you must
    // explicitly indicate contractions using the sum(expr, index)
    // function:
