// From http://www.oonumerics.org/blitz/examples/Blitz++/stencil.cpp
 ...
 * contain the pressure field at three consecutive time steps.  The c
 * array contains the conduction velocity.
 *
 ...
 *      + c(I,J,K) * (P2(I-1,J,K) + P2(I+1,J,K)
 *                    + P2(I,J-1,K) + P2(I,J+1,K)
 *                    + P2(I,J,K-1) + P2(I,J,K+1))
 *      - P1(I,J,K);
 */

/* To declare a stencil object, we use the macro BZ_DECLARE_STENCIL?,
 * where in this case ? is set to 4 (there are 4 arrays involved
 * in the stencil). The notation is greatly simplified by using the
 ...
 * density is gradually decreasing in response to pressure (but only
 * where the conduction velocity is less than 0.5).  This is completely
 * nonsensical, but it illustrates what you can do in a stencil:
 *
...
int main()
{
    ...
    for (int i = 0; i < nIterations; ++i)
    {
        ...
        // Set [P1,P2,P3] <- [P2,P3,P1] to set up for the next time step
