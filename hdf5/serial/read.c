...
/*
 * This example reads a hyperslab from the SDS.h5 file created by the
 * write.c program into a two-dimensional plane of the three-dimensional
 * array. Information about dataset in the SDS.h5 file is obtained.
 */
